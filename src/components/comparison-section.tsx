...
const comparisonItems = [
  {
    icon: DollarSign,
    category: "每月人事成本",
    inhouse: "薪資＋獎金，每月 $50,000 起",
    outsource: "月付 $3,000 起，立省逾 90%",
    highlight: true,
  },
  {
    icon: HeartPulse,
    category: "勞健保／勞退開銷",
    inhouse: "每人每月再加 $8,000 ~ $12,000",
    outsource: "零附加成本，一毛都不必付",
    highlight: false,
  },
  {
    icon: BrainCircuit,
  ...
  },
  {
    ...
    category: "人員離職風險",
    inhouse: "離職即斷線，交接靠運氣",
    outsource: "人員異動零影響，文件完整留存",
    highlight: true,
  },
  {
    icon: Zap,
    category: "資安防護能力",
    inhouse: "全靠個人意識，漏洞難察覺",
    outsource: "多層防護＋定期稽核，主動攔截威脅",
    highlight: false,
  },
  {
    icon: Lightbulb,
